...
namespace CF2025.Sale.DAL
{
    public static class InvoiceBase
    {
        ...
        public static string GenDocNumber(string bill_id,string IDType,string bill_type_no,string bill_date)
        {
            string bill_code = "";
            ...
            {
                bill_code = IDType+bill_type_no + year_month + "00001";//HC21C00006
            ...
            else
            {
                ...
                bill_code = IDType + bill_type_no + year_month + IDSeq;//HC21C00006
