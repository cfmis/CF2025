    ...
    data() {
        return {            
            ...
            rowDataEdit1: { id:'',sequence_id:'',mo_id:'',goods_id:'',goods_name:'',inventory_issuance:'',ii_code:'',ir_lot_no:null,obligate_mo_id:'',
                ...
                transfers_state:'0',ref_sequence_id:'',only_detail:'1',row_status:'' },           
            formRules: {
            ...
            tableColumnLotNo: [
                ...
                { field: 'vendor_id', title: '供應商編號' },
                { field: 'vendor_name', title: '供應商名稱' },
            ],
            tableLotNoList: [{lot_no:'',qty:0,sec_qty:0,mo_id:0,vendor_id:'',vendor_name:''}],
            pagerConfig: {
                total: 0,
                currentPage: 1,
                pageSize: 10
    ...
    methods: {
        ...
        clearRowDataEdit1(){
            this.rowDataEdit1= {
                ...
                rate:1,state:'0',transfers_state:'0',ref_sequence_id:'',only_detail:'1',row_status:'' }
        },
        setRowDataEdit1(curRow) {
            this.rowDataEdit1={
                ...
                transfers_state:'0',ref_sequence_id:curRow.ref_sequence_id,only_detail:1,row_status:curRow.row_status }
        },
        backupData () {
